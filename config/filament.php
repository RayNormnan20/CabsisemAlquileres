    ...
    'broadcasting' => [
        ...
        /*
         'echo' => [
             ...
             'wsHost' => env('VITE_PUSHER_HOST', env('APP_ENV') === 'production' ? 'cabsisem.net.pe' : '127.0.0.1'),
             'wsPort' => env('VITE_PUSHER_PORT', env('APP_ENV') === 'production' ? 6001 : 6001),
             'wssPort' => env('VITE_PUSHER_PORT', env('APP_ENV') === 'production' ? 6001 : 6001),
             'forceTLS' => env('APP_ENV') === 'production',
