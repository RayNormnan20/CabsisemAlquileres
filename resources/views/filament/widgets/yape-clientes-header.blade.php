<div x-data="dateRangePicker()" x-init="init()" class="relative bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-4">
    <h2 class="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Yape Clientes - Control de Entregas</h2>
    ...
    <div class="flex flex-col md:flex-row gap-3 md:items-center">
        ...
        <!-- Selector de estado (sincronizado con la tabla) -->
        <div class="w-full md:w-auto">
            <label class="sr-only">Mostrar</label>
            <select wire:model="estadoFiltro"
                class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-sm text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-600 transition w-full md:w-auto">
                <option value="pendientes">Pendientes</option>
                <option value="devolucion">Completados y excesos</option>
