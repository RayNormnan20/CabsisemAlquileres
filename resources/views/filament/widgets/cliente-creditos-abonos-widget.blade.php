    ...
    <x-filament::card>
        @if(!$usuarioSeleccionado)
            <div class="flex items-center justify-center p-4">
                <p class="text-gray-500">Seleccione un usuario para ver los créditos y abonos asociados.</p>
            </div>
        @else
            <div class="space-y-4">
                <!-- Información del usuario -->
                <div class="p-4 bg-white rounded-lg shadow">
                    <h2 class="text-xl font-bold text-primary-600 mb-2">Información del Usuario</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <p class="font-medium">Nombre: <span class="font-normal">{{ $usuario['nombres'] ?? 'No disponible' }}</span></p>
                            <p class="font-medium">Ruta: <span class="font-normal">{{ $usuario['ruta'] ?? 'No disponible' }}</span></p>
                        </div>
                        <div>
                            <p class="font-medium">Email: <span class="font-normal">{{ $usuario['email'] ?? 'No disponible' }}</span></p>
                            <p class="font-medium">Celular: <span class="font-normal">{{ $usuario['celular'] ?? 'No disponible' }}</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-white rounded-lg shadow">
                    ...
                    @else
                        <div class="p-4 text-center text-gray-500">No hay clientes asociados a este usuario.</div>
                    @endif
                </div>
                -->
